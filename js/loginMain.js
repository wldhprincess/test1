...
$(function () {
  ...
  $("button[data-kt-btn-selectCategory]").click(function () {
    ...
    $("ul[data-kt-btn-showCategoryMenuMain=" + currentCategoryName + "]")
      .css("display", "flex")
      .siblings()
      .hide();
  ...
  $("ul[data-kt-btn-showCategoryMenuMain]").each(function (idx) {
    $("li", this).each(function (idx) {
      // 현재 카테고리 이름 가져오기
      let currentCategoryName = $(this)
        .parents("ul[data-kt-btn-showCategoryMenuMain]")
        .first()
      ...
      $(this).on("mouseover", function (e) {
        ...
        $("div[data-kt-btn-showCategoryMenuFirst=" + currentCategoryName + "]")
          .show()
          .siblings("[data-kt-btn-showCategoryMenuFirst]")
          .hide();
        ...
        $(
          ...
          .eq(idx)
          .find("li:eq(0)")
          .addClass("backgroundBlue")
          .siblings()
          .removeClass("backgroundBlue")
          .end()
          .find(".positionAb:eq(0)")
          .css("display", "flex")
          .end()
          .siblings()
          .find(".positionAb")
    ...
    $("aside li")
      .on("mouseover", function (e) {
        ...
        $(this)
          ...
          .siblings()
          .find("a")
          .removeClass("listHoverA");
      })
      .on("click", function () {
        let currentAsideName = $(this).children().attr("data-kt-aside-path");
        let productWrapBox = $(this)
          .parent()
          .parent()
          .parent()
          .find("div[data-kt-productWrapBox]");
        ...
        productWrapBox.load(
          ...
          function () {
            ...
            $("button.drawingHide, button.sigongHide", productWrapBox).on(
              "click",
              function () {
  ...
  $(".navShow .normal > ul > li").click(function () {
  ...
  $(".navShow .normal .positionAbs li").click(function () {
  ...
  $(".navHide .normal .positionAbs li").click(function () {
    if ($(this).find("button").length) {
      return false;
    } else {
      location.href = "productDetailsMainLog.html";
