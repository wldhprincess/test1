$(function () {
  ...
  // 3번째 메뉴의 클릭 이벤트 설정하는 곳
  $(".selectProductBox .normal .productPhoto").on("click", function () {
    console.log("clcik");
    location.href = "productDetailsMain.html";
  });
  $(".selectProductBox .additional .productPhoto").on("click", function () {
    console.log("clcik");
    location.href = "productDetailsPage.html";
  });
  $(".selectProductBox .addColor .productPhoto").on("click", function () {
    console.log("clcik");
